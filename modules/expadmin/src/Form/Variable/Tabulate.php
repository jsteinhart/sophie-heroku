...
class Tabulate extends \Symbic_Form_Standard
{
	public function init()
	{
		$this->setLegend('Tabulate Variables');
		...
		$order += 100;
		$this->addElement('Multiselect', 'addAggregateRows', array (
			'label' => 'Add Aggregate Rows',
			'multiOptions' => array (
				'avg' => 'Average',
				'count' => 'Count',
				'max' => 'Maximum',
