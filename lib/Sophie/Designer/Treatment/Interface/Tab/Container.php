<?php
class Sophie_Designer_Treatment_Interface_Tab_Container extends Sophie_Designer_Treatment_Interface_Tab_Abstract {
	...
	public function getContent()
	{
		...
		$eventManager->trigger(
			'sophie_designer_treatment_interface_tabcontainer_VARIABLES_prerender',
			null,
			array(
			//	'sophie_admin_session_interface' => $this->getInterface(),
				'sophie_designer_treatment_interface_tabconainer' => $this
				)
		);
