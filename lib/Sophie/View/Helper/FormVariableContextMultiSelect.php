<?php
class Sophie_View_Helper_FormVariableContextMultiSelect extends Zend_View_Helper_FormElement
{
	private $dummyId = '';
	
	public function formVariableContextMultiSelect($name, $value = null, $attribs = null, $options = null, $listsep = "<br />\n")
    {
		...
		foreach ($table as $row)
		{
			...
			foreach ($row as $cell)
			{
				...
				else
				{
					...
					$xhtml .= '<input type="checkbox" name="' . $nameEsc . '[]" value="' . $valueEsc . '" id="' . $cellId . '"';
