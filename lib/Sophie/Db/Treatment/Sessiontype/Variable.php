<?php
class Sophie_Db_Treatment_Sessiontype_Variable extends Symbic_Db_Table_Abstract
{
	// CONFIG
	public $_name = 'sophie_treatment_sessiontype_variable';
	...
	public function fetchRowByNameAndContext($name, $sessiontypeId, $groupLabel = null, $participantLabel = null, $stepgroupLabel = null, $stepgroupLoop = null)
	{
		$select = $this->select();

		$select->where('name = ?', $name);
		$select->where('sessiontypeId = ?', $sessiontypeId);
	...
	public function fetchAllBySessiontypeId($sessiontypeId, $order = null)
	{
	...
	public function setValueByNameAndContext($name, $value, $sessiontypeId, $groupLabel = null, $participantLabel = null, $stepgroupLabel = null, $stepgroupLoop = null)
	{
		$data = array ();
		$data['name'] = $name;
	...
	public function import($sessiontypeId, $data)
	{
		...
		return $this->setValueByNameAndContext($name, $value, $sessiontypeId, $groupLabel, $participantLabel, $stepgroupLabel, $stepgroupLoop);
	}
}